...
public class TrainingEdge {
    ...
    public static void main(String[] args){
        ...
        DDQNAgent ddqnAgent = null;
        if (isTrainingForDDQN){
            ddqnAgent = new DDQNAgent(SS.getNumOfEdgeHosts());
                ...
                for(int k=0; k<SS.getSimulationScenarios().length; k++)
                {
                    for(int i=0; i<SS.getOrchestratorPolicies().length; i++)
                    {
                        ...
                        try
                        {
                            ...
                            ScenarioFactory sampleFactory = new MLScenarioFactory(j,SS.getSimulationTime(), orchestratorPolicy, simScenario);
